...
export const SEED_USERS = [
  ...
  { id: 'u11', name: 'Nadia Osei', email: 'admin@gmail.com', password: 'Admin@123', role: 'admin', avatar: 'NO', avatarColor: 'linear-gradient(135deg,#0d9488,#0f766e)', status: 'active', joinDate: 'Jan 1, 2026', walletBalance: 0 },
];
...
export const SEED_AUDIT_REQUESTS = [
  { id: 'ar1', kind: 'project-audit', taskId: 't2', milestoneId: 'm6', workerId: 'u6', clientId: 'u1', expertId: 'u3', disputeId: null, status: 'paid', agreedAmount: 350, offers: [{ id: 'of1', offeredBy: 'client', amount: 350, note: 'Standard rate for a milestone audit.', status: 'accepted', createdAt: '2026-03-25' }], severity: 'High', project: 'Mobile App Development', worker: 'Michael Chen', milestone: 'Core UI Implementation', createdAt: '2026-03-25', dueDate: '2026-04-01' },
  { id: 'ar2', kind: 'project-audit', taskId: 't1', milestoneId: 'm3', workerId: 'u5', clientId: 'u1', expertId: null, disputeId: null, status: 'preview-sent', agreedAmount: null, offers: [], severity: 'Medium', project: 'E-commerce Website Redesign', worker: 'Sarah Johnson', milestone: 'Backend Integration', createdAt: '2026-03-28', dueDate: '2026-04-05' },
  { id: 'ar3', kind: 'project-audit', taskId: 't4', milestoneId: 'm9', workerId: 'u7', clientId: 'u1', expertId: 'u3', disputeId: null, status: 'paid', agreedAmount: 280, offers: [{ id: 'of2', offeredBy: 'expert', amount: 280, note: 'Scoped to the permission model only.', status: 'accepted', createdAt: '2026-03-20' }], severity: 'Low', project: 'Content Management System', worker: 'Emily Rodriguez', milestone: 'User Permission System', createdAt: '2026-03-20', dueDate: '2026-03-27' },
];
