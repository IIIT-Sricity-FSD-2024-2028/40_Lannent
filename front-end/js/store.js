...
const Store = (() => {
  ...
  const SEED = {
    users: [
      { id: 'u1', name: 'James Client', email: 'client@lannent.com', password: 'password123', role: 'client', avatar: 'JC', avatarColor: 'linear-gradient(135deg,#6366f1,#4f46e5)', status: 'active', joinDate: 'Jan 10, 2026', walletBalance: 24500, company: 'TechCorp Ltd', location: 'New York, NY' },
      { id: 'u2', name: 'Alex Worker', email: 'worker@lannent.com', password: 'password123', role: 'worker', avatar: 'AW', avatarColor: 'linear-gradient(135deg,#10b981,#059669)', status: 'active', joinDate: 'Feb 1, 2026', walletBalance: 8200, skills: ['React','Node.js','MongoDB'], rating: 4.8, completedProjects: 23 },
      { id: 'u3', name: 'Dr. Jane Smith', email: 'expert@lannent.com', password: 'password123', role: 'expert', avatar: 'JS', avatarColor: 'linear-gradient(135deg,#a855f7,#7c3aed)', status: 'active', joinDate: 'Jan 20, 2026', walletBalance: 5100, specialization: 'Full-Stack & Security', reviewsDone: 47 },
      { id: 'u4', name: 'Super Admin', email: 'super@lannent.com', password: 'superadmin123', role: 'superuser', avatar: 'SA', avatarColor: 'linear-gradient(135deg,#ef4444,#dc2626)', status: 'active', joinDate: 'Jan 1, 2026', walletBalance: 0 },
      { id: 'u5', name: 'Sarah Johnson', email: 'sarah@example.com', password: 'password123', role: 'worker', avatar: 'SJ', avatarColor: 'linear-gradient(135deg,#6366f1,#4f46e5)', status: 'active', joinDate: 'Feb 5, 2026', walletBalance: 12400, skills: ['React','Figma','UI/UX Design'], rating: 4.9, completedProjects: 89 },
      { id: 'u6', name: 'Michael Chen', email: 'michael@example.com', password: 'password123', role: 'worker', avatar: 'MC', avatarColor: 'linear-gradient(135deg,#ec4899,#be185d)', status: 'active', joinDate: 'Feb 10, 2026', walletBalance: 9800, skills: ['React','Node.js','MongoDB'], rating: 4.7, completedProjects: 65 },
      { id: 'u7', name: 'Emily Rodriguez', email: 'emily@example.com', password: 'password123', role: 'worker', avatar: 'ER', avatarColor: 'linear-gradient(135deg,#10b981,#059669)', status: 'active', joinDate: 'Feb 15, 2026', walletBalance: 7300, skills: ['Figma','CSS3','User Research'], rating: 4.8, completedProjects: 41 },
      { id: 'u8', name: 'Bob Client', email: 'bob@example.com', password: 'password123', role: 'client', avatar: 'BC', avatarColor: 'linear-gradient(135deg,#f59e0b,#d97706)', status: 'active', joinDate: 'Mar 1, 2026', walletBalance: 15000, company: 'StartupXYZ', location: 'Austin, TX' },
    ],
